const english = {
  ...
  store_city_chat_srv_leave: '@n leave the city.',
  store_city_chat_srv_upgrade: 'Building @b upgraded to level @l!',
  store_city_chat_srv_donate: '@n made a large donate to @b - @c.',
  store_city_chat_srv_prizes: 'Congratulations to residents on the prizes! :)',
  ...
  modals_complaint_attention_2: 'If this message violates game rules, then you can complain it.',
