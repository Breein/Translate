const english = {
  ...
  city_buildings_bank_3: "Determines the number of prize tickets in the rating of city residents who have scored the required number of points. Мне нужно объяснение, я не уверен, что понимаю описание.",
  city_buildings_bank_4: "Capacity",
 ...
 get into city_buildings_success_13: "Booster operating time:",
  ...
  city_help_page_7: "For example, the Cafe increases the number of cookies falling during a Cookie Rain, and the Candy Factory increases the duration of the Income Accelerator.",
  ...
  free_cookies_3: "Just for first-time app users who manage to crack open at least three fortune cookies.",
  free_cookies_4: "Invite your friends and claim cookies when they start playing!",
  free_cookies_5: "for everyone!",
  free_cookies_6: "Just for first-time app users who manage to crack open at least three fortune cookies.",
  ...
  game_cookie_rain_layer_1: "It's time to combine",
  ...
  game_leagues_tutorial_4_1: 'combination points',
  game_leagues_tutorial_5: 'Other players are active and earning their combination points too.',
  ...
  game_main_tutor_1: "Combine similar cookies",
  ...
  game_main_tutor_6: "to combine cookies",
  game_main_tutor_7: "to unlock cool new cookies!",
  game_main_tutor_8: "Let's start combining and see what happens.",
  game_main_tutor_9: "Go!",
  game_main_tutor_10: "Buy!",
  game_main_tutor_11: "Great! But there is nothing left to combine.",
  game_main_tutor_12: "We need",
  game_main_tutor_13: "to buy more",
  game_main_tutor_14: "cookies to continue playing",
  ...
  game_main_tutor_23: "Combine the purchased cookies to unlock a new cookie level!",
  ...
  main_crush_tutorial_10: "Make sure you play the game.",
  main_crush_tutorial_11: "So you can get",
  main_crush_tutorial_12: "free cookies!",
  ...
  modals_battle_help_2: "In this mode, you must make more cookie combinations in less time than your opponent.",
  ...
  modals_no_hard_shop: "Go to shop",
  ...
  store_city_tutorial_3: "HHere, you can view the ratings of every city resident.",
  ...
  store_game_tutorial_battle_3: "TThe goal of the game is to combine more cookies than your opponent within 60 seconds.",
  store_game_tutorial_battle_4: "Game play time and number of connections are shown above.",
  ...
  chapter_hint_m2: 'Combine two identical cookies on your game table.',
  ...
  chapter_hint_m7: 'Go to the plates upgrade section ("Improvements" tab) and level up the plates',
  ...
  chapter_hint_m13: 'Arrange the cookies on the game table in order of cookie level.',
  ...
  chapter_hint_m15: 'Activate the «prize» Rocket Booster, in cost, «Prize» must be indicated. It is located in the "Improvements" tab in the game. Я должен увидеть этот текст в игре, потому что он не имеет смысла.',
  ...
  chapter_hint_d7: 'Don\'t close the application just yet. Stay with us a little longer.',
  ...
  main_crush_button_prize_crush: 'Free:',
  ...
  achievement_hint_4: 'Combine identical cookies on your game table to increase your progress.',
  ...
  achievement_name_11: 'Prize Sector Этот термин не подходит для американского рынка, поскольку ему не придают значения. Может быть, что-то вроде "Reward Zone (Зона Наград)", "Fortunate Spinner, (Счастливый Вращатель)" или "Lucky Spinner (Удачливый Вращатель)" будет более подходящим.',
