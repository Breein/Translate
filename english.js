const english = {
  ...
  app_settings_music_bg: "Play in the minimized",
  app_settings_sounds: "Sounds",
  app_settings_rain: "Cookie rain speed",
  app_welcome_1: "Hello!",
  app_welcome_2: "registration is completed",
  app_welcome_3: "Login:",
  ...
  city_buildings_bank_4: "Specifications",
  ...
  city_buildings_brickyard_2: "Allows the production of bricks necessary for the construction and improvement of city buildings",
  city_buildings_brickyard_3: "Production",
  city_buildings_brickyard_4: "Select the quantity:",
  ...
  city_buildings_brickyard_14: "the daily limit has been reached",
  ...
  city_buildings_cafe_3: "Increase now:",
  city_buildings_cafe_4: "After the improvement:",
  city_buildings_cafe_5: "pcs.",
  city_buildings_candy_factory_1: "Candy Factory",
  city_buildings_candy_factory_2: "Allows you to increase the operating time of the booster when it is activated",
  city_buildings_candy_factory_3: "Increasing the time:",
  city_buildings_candy_factory_4: "min.",
  city_buildings_city_hall_1: "City Hall",
  city_buildings_city_hall_2: "Responsible for the maximum number of residents (participants) in the city",
  city_buildings_city_hall_3: "Limit now:",
  city_buildings_city_hall_4: "residents",
  city_buildings_city_hall_5: "After the improvement:",
  city_buildings_mill_1: "Mill",
  city_buildings_mill_2: "Increases the chance of high-level cookies falling out during the cookie rain",
  city_buildings_mill_3: "Chance increased:",
  city_buildings_mill_4: "by",
  city_buildings_success_1: "The construction is completed!",
  city_buildings_success_2: "The building level has been raised to",
  city_buildings_success_3: "",
  city_buildings_success_4: "Efficiency is increased!",
  ...
  city_buildings_success_12: "The chance of a cookie falling out of an increased level:",
  ...
  city_buildings_upgrade_3: "Cookies are required",
  city_buildings_upgrade_4: "Bricks required",
  city_buildings_upgrade_5: "Buy",
  city_buildings_upgrade_6: "To produce",
  ...
  city_control_members_3: "For all the time",
  ...
  city_help_page_7: "For example, a cafe increases the number of cookies falling out in a cookie fall, and a confectionery factory increases the operating time of the income accelerator.",
  ...
  city_help_page_29: "Allows you to increase the popularity of your city and attract the most active players.",
  ...
  city_tutorial_free_panel_3: "Join the city that you like or create your own for cookies!",
  ...
  city_welcome_page_5: "The time has come for a good ruler. Make your city the best!",
  city_welcome_page_6: "Go!",
  city_welcome_page_7: "to the city",
  city_welcome_page_8: "Upgrade buildings and get bonuses for it in the game,\nchat with other residents in the chat, as well as\ncompete with other cities.",
  ...
  free_cookies_1: "Complete the tasks and collect the reward here every day!",
  free_cookies_2: "Make reposts and get for every new player who comes in on your links",
  free_cookies_3: "only for those who have never opened the app before and will crush at least three cookies",
  free_cookies_4: "Invite your friends and pick up cookies here when they start playing!",
  free_cookies_5: "for everyone!",
  free_cookies_6: "only for those who have never opened the app before and will crush at least three cookies",
  free_cookies_get: "Get",
  free_cookies_gifts: "Gifts",
  free_cookies_in_day: "in the day",
  free_cookies_invite: "Invite a friend",
  free_cookies_perform: "Perform",
  ...
  free_cookies_wall: "Share on the wall",
  free_cookies_share: "Share a game",
  game_Free: "For free",
  ...
  game_cookie_rain_layer_1: "Have time to merge",
  ...
  game_leagues_tutorial_1: 'Congratulations\nYou unlocked leagues!',
  game_leagues_tutorial_2: 'This is a competition with other players for',
  game_leagues_tutorial_2_1: 'prize cookies',
  game_leagues_tutorial_3: 'Fine',
  game_leagues_tutorial_4: 'By combining cookies you get',
  game_leagues_tutorial_4_1: 'merges points',
  game_leagues_tutorial_5: 'Other players are on the alert and also receive their merges points.',
  game_leagues_tutorial_6: 'I understand',
  game_leagues_tutorial_7: 'The league lasts one week, this timer shows',
  game_leagues_tutorial_7_1: 'time to over',
  game_leagues_tutorial_8: 'Get into the',
  ...
  game_leagues_tutorial_9_3: 'cooler league',
  game_leagues_tutorial_10: 'Go merging!',
  ...
  game_main_biggest_2: "A new level of cookies!",
  ...
  game_main_left_menu_leagues: 'To unlock leagues,\nget a level 7 cookie!',
  game_main_left_menu_city: 'Cities will be available\nafter level 10 cookie!',
  game_main_rain_3: "Cause a rain of cookies on your gaming table",
  ...
  game_main_sack_take: 'Take',
  game_main_tutor_1: "Merge identical cookies",
  ...
  game_main_tutor_6: "to connect cookies",
  ...
  game_main_tutor_11: "Super! But there is nothing more to merge.",
  ...
  game_main_tutor_21: "The higher the level of the cookie, the more coins it",
  game_main_tutor_22: "earns per second",
  game_main_tutor_23: "Merge the purchased cookies to get a new level!",
  ...
  game_income_description: "Earn even more silver coins when you're not in the game!",
  game_income_level: "Level",
  game_income_upgrade: "Upgrade",
  game_income_prize: "Prize!",
  game_leagues_1: " winners get cookies",
  game_leagues_2: " winners move to a new league and get cookies",
  game_leagues_3: "League relegation zone",
  game_plates_footer_1: "Improve the plates and cookies that lie on them, they will bring more X income!",
  game_plates_footer_2: "Place the best cookies on the best plates!",
  game_plates_footer_done: "Done",
  game_plates_plates_sale: "The sale will end in:",
  ...
  main_main_cookie_text_1: "How do you like the prediction?",
  main_share_buttons_invite: "Invite a friend",
  main_share_buttons_published: "Published",
  main_share_buttons_story: "To the story",
  main_share_buttons_wall: "To the wall",
  main_share_buttons_share: "Share predict",
  modals_battle_help_1: "Welcome to the PvP battle mode with a real player.",
  modals_battle_help_2: "In this mode, you have to make more cookie merges in a short time than your opponent.",
  ...
  modals_no_hard_shop: "To the shop",
  ...
  modals_offline_profit_2: "the cookies earned",
  modals_offline_profit_3: "Time of offline income",
  modals_offline_profit_4: "0 h",
  modals_offline_profit_5: "Triple it!",
  modals_offline_profit_6: "Get x3",
  ...
  store_city_tutorial_1: "There are buildings on the city map and they already give you bonuses!",
  store_city_tutorial_2: "If you improve them, you will get more bonuses and rewards in the game.",
  store_city_tutorial_3: "Here is the rating of residents of the city.",
  store_city_tutorial_4: "Compete with other residents to get rewards!",
  store_city_tutorial_5: "And here, the rating of other cities.",
  store_city_tutorial_6: "Residents should join forces to make your city the best!",
  ...
  store_game_main_3: "A new level of cookies! ",
  ...
  store_game_tutorial_battle_3: "The goal of the game is to merge more cookies than the opponent in 60 seconds.",
  store_game_tutorial_battle_4: "The game time and number of connections are shown above.",
  ...
  store_rating_4: "For all the time",
  ...
  store_shop_4: "For the first purchase, get three times more cookies at the usual price!",
  store_shop_5: "Multiply cookies X3",
  ...
  store_user_user_4: "Subscribe on messages from group",
  store_user_user_5: "Write to the group «Hello!»",
  store_user_user_6: "Share on the wall",
  ...
  store_wheel_20: "conquer leagues, get prizes",
  ...
  chapter_until_refresh: 'Until update',
  chapter_chapter_rank: 'Rank:',
  chapter_chapter_ended: 'Until end:',
  ...
  chapter_hint_m2: 'Merge two identical cookies on your gaming table.',
  ...
  chapter_hint_m8: 'At the end of your league in the game, you must be in 20th place or higher.',
  ...
  chapter_hint_m12: 'Start the cookie rain and don\'t miss a single cookie past the gaming table, catching them all.',
  chapter_hint_m13: 'Place on your gaming table the required number of cookies with levels in order.',
  chapter_hint_m14: 'Your gaming table must contain the required number of cookies with levels in order, from your biggest cookie to the smallest.',
  chapter_hint_m15: 'Activate the «prize» rocket booster, in cost, «Prize» must be indicated. It is located in the «Improvements» tab in the game.',
  ...
  chapter_hint_p2: 'Choose any prediction category, except for "For Day" and crush the cookie.',
  ...
  chapter_hint_d7: 'Do not close the application for the required time. Stay with us a little longer.',
  ...
  chapter_next_level_vip_offer_2: 'take all rewards',
  ...
  chapter_refresh_message: 'If you don’t like this quest, you can replace it with another one chosen randomly.',
  ...
  main_categories_title_2: 'PREDICTION CATEGORY',
  ...
  main_crush_tutorial_share_1: 'Share predictions with your',
  ...
  shop_sales_container_bonus_success_1: 'Nice! Gift received.',
  shop_sales_container_bonus_success_2: 'Come to the shop so as not to miss new gifts and promotions.',
  shop_sales_container_bonus_take: 'Take',
  shop_sales_container_left: 'Remaining: ',
  shop_shop_page_title: 'Shop',
  ...
  store_shop_eb_text: 'New sales and gifts coming soon. Come to the shop often so you don\'t miss anything!',
  ...
  share_wall_special_footer_1: 'What awaits you today?',
  share_wall_special_footer_2: 'Hurry up open the fortune cookie!',
  share_wall_predict_footer_1: 'What awaits you today?',
  share_wall_predict_footer_2: 'Hurry up open the fortune cookie!',
  ...
  achievement_description_6: 'Start the «Cookie rain»',
  achievement_hint_6: 'Start the «Cookie rain» in the game. The button is located in the «Improvements» tab.',
  ...
  achievement_description_8: 'Open predictions',
  ...
  achievement_description_10: 'Give gifts someone other',
  ...
  achievement_name_11: 'Prize Sector',
  ...
  achievement_description_12: 'Win the «Prize» with cookies',
  ...
  achievement_description_14: 'Produce the «Bricks»',
  ...
  achievement_description_17: 'Get 45 level of adventures',
  ...
  achievement_description_19: 'Collect the stars of adventure',
  ...
  achievements_page_all_progress: 'All progress',
